...
<body>
    <div style="width:310px;margin: 0px auto;">
        <form action="${APP_PATH }/user/login" method="POST" style="position: absolute;top: 250px;">
            ...
            <div style="margin-left: 80px">${message}</div>
            <input type="submit" value="登录"  style="margin-left: 91px;margin-top: 10px;border-radius:7px;line-height: 25px;font-size: 14px;width:104px;background-color: #f8f4f4"><br>
            <a style="margin-top: 10px;margin-left: 90px" id="btn" href="${APP_PATH}/easyui-html/register.jsp" class="easyui-linkbutton" data-options="iconCls:'icon-search'">点我去注册</a>
        </form>
    </div>
</body>
</html>
